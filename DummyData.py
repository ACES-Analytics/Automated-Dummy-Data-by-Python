...
num_ctry = 50 # number of fake countries
num_cust = 50 # number of fake customers
num_dates = 30000 # number of fake dates
...
df_dates4['Sales Volume'] = pd.DataFrame(np.random.randint(1000,5000,df_len))
...
# Excluding a few specific fake data
df_sales.loc[df_sales['Country'] == "Hong Kong",'Country'] = "Other Country"
df_sales.loc[df_sales['Country'] == "Macao",'Country'] = "Other Country"
df_sales.loc[df_sales['Country'] == "Taiwan",'Country'] = "Other Country"
